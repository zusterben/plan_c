...
echo_date "yaml文件预处理中【后台处理】，请在日志页面看到完成后，再启动Clash！！！" >> $LOG_FILE
sleep 2s
#去注释
...
echo_date "移动yaml文件到/jffs/softcenter/merlinclash/yaml_bak/ 以" >> $LOG_FILE
echo_date "及/jffs/softcenter/merlinclash/yaml_use/目录下" >> $LOG_FILE
